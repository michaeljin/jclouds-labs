 ...
 */
package org.jclouds.digitalocean2.compute.util;
...
/**
 * Utility class to encode and decode the region id and name in a {@link org.jclouds.domain.Location}.
 */
public class LocationNamingUtils {
    ...
    */
   public static String extractRegionId(Location location) {
      ...
      checkArgument(index >= 0, "location description should be in the form 'regionId/regionName' but was: %s",
            regionIdAndName);
      return regionIdAndName.substring(0, index);
   }
   ...
   /**
    * Encodes the id and name of the given region into a String so it can be populated in a {@link org.jclouds.domain.Location} object.
    * 
